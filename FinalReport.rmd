...
Both race and cappun are categorical variables so the analysis technique is CAT~CAT; plot is a barplot, summary is a cross-table, inference is chi-squared test.
